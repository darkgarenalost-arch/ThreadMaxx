...
function renderSummary() {
  ...
  $("#checkout-summary").innerHTML = `
    ...
    <p class="muted text-sm mt-4">Free shipping above ${formatMoney(brandConfig.freeShippingAbove)}. COD and Razorpay remain available for ThreadMaxx orders.</p>
  `;
