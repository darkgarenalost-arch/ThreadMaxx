export const fallbackBanners = [
  {
    ...
    subtitle: "Monochrome staples, strong silhouettes and everyday pieces cut for confident movement.",
  ...
  },
  {
    ...
    subtitle: "Clean layers, deep blacks, structured denim and polished essentials for the city wardrobe.",
  ...
  {
    title: "The Utility Edit",
    eyebrow: "New arrivals",
    subtitle: "Relaxed co-ords, sharp tops and denim shapes with a minimal ThreadMaxx attitude.",
...
export const fallbackProducts = [
  {
    ...
    description: "A sharp straight kurti with clean contrast detailing, designed for day plans and after-dark plans."
  },
  {
    id: "fh-denim-wide",
  ...
  },
  {
    ...
    description: "A confidence-first matching set with fluid tailoring and a deep monochrome mood."
  },
  {
    id: "fh-chain-bag",
...
export const reviews = [
  { name: "Aarohi", city: "Mumbai", text: "The co-ord looked even better in real life. The finish felt premium and COD was smooth.", rating: 5 },
  { name: "Mehak", city: "Delhi", text: "Loved the kurti fit. It feels clean, dressy and still comfortable for long days.", rating: 5 },
  { name: "Ishita", city: "Pune", text: "Fast delivery, minimal packaging and the handbag quality is honestly impressive for the price.", rating: 5 }
];
